...
| :--- | :--- |
| **[GRIT](https://github.com/alx-sch/GRIT)** | A production-grade social event platform featuring real-time chat, interactive maps, and an invite system. Engineered as a fully type-safe Turborepo monorepo utilizing React, NestJS, Prisma, PostgreSQL, Socket.IO, and MinIO storage. |
...
🤝 **Let's connect!** > [LinkedIn](https://www.linkedin.com/in/alex-o-schenk/)
